...
// GetDigestAsString
void
SHA256::GetDigestAsString(BString& string)
{
	size_t digestLength = DigestLength();
	const uint8* digest = Digest();
	char temp[16];
	// NOTE: this is the same string representation that the server uses
