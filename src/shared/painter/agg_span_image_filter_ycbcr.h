...
//----------------------------------------------------------------------------
#ifndef AGG_SPAN_IMAGE_FILTER_YCBCR_INCLUDED
#define AGG_SPAN_IMAGE_FILTER_YCBCR_INCLUDED
...
namespace agg
{
    ...
    //===============================================span_image_filter_ycbcr422_nn
    template<class Source, class Interpolator> 
    class span_image_filter_ycbcr422_nn : 
    ...
    public:
        ...
        //--------------------------------------------------------------------
        span_image_filter_ycbcr422_nn() {}
        span_image_filter_ycbcr422_nn(source_type& src, 
        ...
        void generate(color_type* span, int x, int y, unsigned len)
        {
            ...
            do
            {
                ...
                int imageX = x >> image_subpixel_shift;
                const value_type* fg_ptr = (const value_type*)
                    base_type::source().span(imageX, 
                                             y >> image_subpixel_shift, 
                                             1);
				int offset = (imageX & 1) << 1;
				span->y = fg_ptr[0];
				span->cb = fg_ptr[1 - offset];
	            // TODO: avoid out of bounds access!
	            // (though it is no problem if picture
	            // width is multiple of 2)
				span->cr = fg_ptr[3 - offset];
                span->a = base_mask;
    ...
    //===============================================span_image_filter_ycbcr444_nn
    template<class Source, class Interpolator> 
    class span_image_filter_ycbcr444_nn : 
    public span_image_filter<Source, Interpolator>
    {
    public:
        typedef Source source_type;
        ...
        //--------------------------------------------------------------------
        span_image_filter_ycbcr444_nn() {}
        span_image_filter_ycbcr444_nn(source_type& src, 
                                      interpolator_type& inter) :
            base_type(src, inter, 0) 
        {}
    ...
    //==========================================span_image_filter_ycbcr444_bilinear
    template<class Source, class Interpolator> 
    class span_image_filter_ycbcr444_bilinear : 
    public span_image_filter<Source, Interpolator>
    {
    public:
        typedef Source source_type;
        ...
        //--------------------------------------------------------------------
        span_image_filter_ycbcr444_bilinear() {}
        span_image_filter_ycbcr444_bilinear(source_type& src, 
                                            interpolator_type& inter) :
            base_type(src, inter, 0) 
        {}
        ...
        void generate(color_type* span, int x, int y, unsigned len)
        {
            ...
            do
            {
                ...
                span->y = value_type(fg[0] >> (image_subpixel_shift * 2));
                span->cb = value_type(fg[1] >> (image_subpixel_shift * 2));
                span->cr = value_type(fg[2] >> (image_subpixel_shift * 2));
                span->a = base_mask;
    ...
    //=====================================span_image_filter_ycbcr444_bilinear_clip
    template<class Source, class Interpolator> 
    class span_image_filter_ycbcr444_bilinear_clip : 
    public span_image_filter<Source, Interpolator>
    {
    public:
        typedef Source source_type;
        ...
        //--------------------------------------------------------------------
        span_image_filter_ycbcr444_bilinear_clip() {}
        span_image_filter_ycbcr444_bilinear_clip(source_type& src, 
        ...
        void generate(color_type* span, int x, int y, unsigned len)
        {
            ...
            do
            {
                ...
                span->y = (value_type)fg[0];
                span->cb = (value_type)fg[1];
                span->cr = (value_type)fg[2];
    ...
    //===============================================span_image_filter_ycbcr444_2x2
    template<class Source, class Interpolator> 
    class span_image_filter_ycbcr444_2x2 : 
    public span_image_filter<Source, Interpolator>
    {
    public:
        typedef Source source_type;
        ...
        //--------------------------------------------------------------------
        span_image_filter_ycbcr444_2x2() {}
        span_image_filter_ycbcr444_2x2(source_type& src, 
                                       interpolator_type& inter,
    ...
    //===================================================span_image_filter_ycbcr444
    template<class Source, class Interpolator> 
    class span_image_filter_ycbcr444 : 
    public span_image_filter<Source, Interpolator>
    {
    public:
        typedef Source source_type;
        ...
        //--------------------------------------------------------------------
        span_image_filter_ycbcr444() {}
        span_image_filter_ycbcr444(source_type& src, 
                                   interpolator_type& inter,
                                   const image_filter_lut& filter) :
            base_type(src, inter, &filter) 
        {}
    ...
    //==========================================span_image_resample_ycbcr444_affine
    template<class Source> 
    class span_image_resample_ycbcr444_affine : 
    ...
    public:
        ...
        //--------------------------------------------------------------------
        span_image_resample_ycbcr444_affine() {}
        span_image_resample_ycbcr444_affine(source_type& src, 
                                            interpolator_type& inter,
                                            const image_filter_lut& filter) :
            base_type(src, inter, filter) 
        {}
    ...
    //=================================================span_image_resample_ycbcr444
    template<class Source, class Interpolator>
    class span_image_resample_ycbcr444 : 
    ...
    public:
        ...
        //--------------------------------------------------------------------
        span_image_resample_ycbcr444() {}
        span_image_resample_ycbcr444(source_type& src, 
                                     interpolator_type& inter,
                                     const image_filter_lut& filter) :
            base_type(src, inter, filter)
        {}
