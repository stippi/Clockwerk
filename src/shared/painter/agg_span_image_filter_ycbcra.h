...
// 
//----------------------------------------------------------------------------
#ifndef AGG_SPAN_IMAGE_FILTER_YCBCRA_INCLUDED
#define AGG_SPAN_IMAGE_FILTER_YCBCRA_INCLUDED
...
namespace agg
{
    ...
    //==============================================span_image_filter_ycbcra_nn
    template<class Source, class Interpolator> 
    class span_image_filter_ycbcra_nn : 
    ...
    public:
        ...
        //--------------------------------------------------------------------
        span_image_filter_ycbcra_nn() {}
        span_image_filter_ycbcra_nn(source_type& src, 
    ...
    //=========================================span_image_filter_ycbcra_bilinear
    template<class Source, class Interpolator> 
    class span_image_filter_ycbcra_bilinear : 
    public span_image_filter<Source, Interpolator>
    {
    public:
        typedef Source source_type;
        ...
        //--------------------------------------------------------------------
        span_image_filter_ycbcra_bilinear() {}
        span_image_filter_ycbcra_bilinear(source_type& src, 
                                        interpolator_type& inter) :
            base_type(src, inter, 0) 
        {}
        ...
        void generate(color_type* span, int x, int y, unsigned len)
        {
            ...
            do
            {
                ...
                span->a = value_type(fg[3] >> (image_subpixel_shift * 2));
    ...
    //====================================span_image_filter_ycbcra_bilinear_clip
    template<class Source, class Interpolator> 
    class span_image_filter_ycbcra_bilinear_clip : 
    public span_image_filter<Source, Interpolator>
    {
    public:
        typedef Source source_type;
        ...
        //--------------------------------------------------------------------
        span_image_filter_ycbcra_bilinear_clip() {}
        span_image_filter_ycbcra_bilinear_clip(source_type& src, 
    ...
    //==============================================span_image_filter_ycbcra_2x2
    template<class Source, class Interpolator> 
    class span_image_filter_ycbcra_2x2 : 
    public span_image_filter<Source, Interpolator>
    {
    public:
        typedef Source source_type;
        ...
        //--------------------------------------------------------------------
        span_image_filter_ycbcra_2x2() {}
        span_image_filter_ycbcra_2x2(source_type& src, 
                                   interpolator_type& inter,
    ...
    //==================================================span_image_filter_ycbcra
    template<class Source, class Interpolator> 
    class span_image_filter_ycbcra : 
    public span_image_filter<Source, Interpolator>
    {
    public:
        typedef Source source_type;
        ...
        //--------------------------------------------------------------------
        span_image_filter_ycbcra() {}
        span_image_filter_ycbcra(source_type& src, 
                               interpolator_type& inter,
                               const image_filter_lut& filter) :
            base_type(src, inter, &filter) 
        {}
    ...
    //========================================span_image_resample_ycbcra_affine
    template<class Source> 
    class span_image_resample_ycbcra_affine : 
    ...
    public:
        ...
        //--------------------------------------------------------------------
        span_image_resample_ycbcra_affine() {}
        span_image_resample_ycbcra_affine(source_type& src, 
                                        interpolator_type& inter,
                                        const image_filter_lut& filter) :
            base_type(src, inter, filter) 
        {}
    ...
    //==============================================span_image_resample_ycbcra
    template<class Source, class Interpolator>
    class span_image_resample_ycbcra : 
    ...
    public:
        ...
        //--------------------------------------------------------------------
        span_image_resample_ycbcra() {}
        span_image_resample_ycbcra(source_type& src, 
                                 interpolator_type& inter,
                                 const image_filter_lut& filter) :
            base_type(src, inter, filter)
        {}
